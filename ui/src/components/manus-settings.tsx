      ...
      <FieldGroup>
        <FieldSet>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription className="text-gray-500">
                    WhiskerAgent 使用标准的 A2A 协议来连接远程 Agent。
                    <br />
                    ...
                    <FieldSet>
                      <Field>
                        <Input
                          id="a2a_base_url"
                          type="url"
                          placeholder="Example: https://whisker-manus.com/weather-agent"
                          value={addUrl}
          ...
          <FieldDescription className="text-sm">
            模型上下文协议 (MCP) 通过集成外部工具来增强 WhiskerAgent
            ...
            <Dialog open={addDialogOpen} onOpenChange={setAddDialogOpen}>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription className="text-gray-500">
                    WhiskerAgent 使用标准的 JSON MCP 配置来创建新服务器。
